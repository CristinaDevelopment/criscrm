...
export const uploadFileSites = async (
  file: any,
  parentId: string,
  siteId: string,
): Promise<string> => {
...
export const deleteFileSites = async (name: string): Promise<string> => {
  cloudinary.config({
    cloud_name: process.env.CLOUDINARY_NAME_SITES,
    api_key: process.env.CLOUDINARY_API_KEY_SITES,
    api_secret: process.env.CLOUDINARY_API_SECRET_SITES,
...
export const deleteFilesSites = async (parentId: string): Promise<string> => {
  cloudinary.config({
    cloud_name: process.env.CLOUDINARY_NAME_SITES,
    api_key: process.env.CLOUDINARY_API_KEY_SITES,
    api_secret: process.env.CLOUDINARY_API_SECRET_SITES,
