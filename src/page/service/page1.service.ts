...
import { Page1Repository } from '../repository/page.repository';

@Injectable()
export class Page1Service {
  constructor(
    private readonly pageRepository: Page1Repository, // @Inject('PRODUCT_SERVICE') // private readonly communicationCliente: ClientProxy,
  ) {}
