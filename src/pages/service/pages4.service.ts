...
import { Page4 } from '../entities/page.model';
import { PageDocument } from '../entities/page.schema';
import { Pages4Repository } from '../repository/pages.repository';

@Injectable()
export class Pages4Service {
  constructor(
    private readonly pageRepository: Pages4Repository, // @Inject('PRODUCT_SERVICE') // private readonly communicationCliente: ClientProxy,
  ) {}
